...
import 'package:notu/app/widgets/side_bar/models/sidebarx_item.dart';
import 'package:notu/app/widgets/side_bar/theme/sidebarx_theme.dart';
import 'package:notu/app/widgets/side_bar/utils/types.dart';
import 'package:notu/app/widgets/side_bar/widgets/sidebarx_cell.dart';
...
class _SidebarXState extends State<SidebarX>
  ...
  void initState() {
    ...
    widget.controller.extendStream.listen((extended) {
  ...
  Widget _buildToggleButton(
    ...
    final buildedToggleButton = widget.toggleButtonBuilder?.call(
      context,
      widget.controller.extended,
    );

...
class _SideMenuItemState extends State<SideMenuItemWithGlobal> {
  ...
  void initState() {
    super.initState();
    _nonNullableWrap(WidgetsBinding.instance)!.addPostFrameCallback((
      timeStamp,
    ) {
  ...
  Widget _generateIcon(Icon? mainIcon, Widget? iconWidget) {
    ...
    final Icon icon = Icon(mainIcon.icon, color: iconColor, size: iconSize);
          ...
          child: Container(
            ...
            child: ValueListenableBuilder(
              ...
              builder: (context, value, child) {
                return Tooltip(
                  message:
                      (value == SideMenuDisplayMode.compact &&
